...
input_file ="D:/Sensorprobe/version_2/activity_sanding_01.csv"

output_file = 'sanding.csv'
...
columns_to_delete = ["b'Port", "b'Port.1", "b'Port.2", "b'Port.3", "b'Port", 'port', "b'Port.1", "b'Port.3", "b'Port.2"]
